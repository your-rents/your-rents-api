...
public enum PropertyType {
  ...
  CONDOMINIUM("Condominium", "A unit in a building owned individually but with shared common areas."),
  ...
  /**
   * Returns the corresponding enum constant for a given database value.
   * If no match is found, throws an IllegalArgumentException.
   */
